...
def show_pcl(pcl):
    ...
    global exit_not_pressed
    exit_not_pressed = True

    def key_callback(vis):
        global exit_not_pressed
        exit_not_pressed = False
        print('callback key is pressed')
...
def show_range_image(frame, lidar_name):
    ...
    ri_intensity = np.clip(ri_intensity, percentile_1, percentile_99) /percentile_99 * 255
