...
static double calc_dist(double x_1, double x_2, double y_1, double y_2)
{
  auto x_abs = std::abs(x_1 - x_2);
  auto y_abs = std::abs(y_1 - y_2);
    ...
    for (size_t c = 0; c < n_circles && !collision; ++c) {
      ...
      for (auto obst : obstacles) {
        ...
        for (size_t c2 = 0; c2 < n_circles && !collision; ++c2) {
          ...
          // obstacle/actor
          double dist = calc_dist(actor_center_x, circle_center_x, actor_center_y, circle_center_y);  // <- Update
